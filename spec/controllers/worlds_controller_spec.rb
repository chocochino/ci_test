...
RSpec.describe WorldsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      world = World.create! valid_attributes
      get :edit, params: {id: world.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new World" do
        expect {
          post :create, params: {world: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {world: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested world" do
        world = World.create! valid_attributes
        put :update, params: {id: world.to_param, world: new_attributes}, session: valid_session
        world.reload
      ...
      it "redirects to the world" do
        world = World.create! valid_attributes
        put :update, params: {id: world.to_param, world: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        world = World.create! valid_attributes
        put :update, params: {id: world.to_param, world: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
